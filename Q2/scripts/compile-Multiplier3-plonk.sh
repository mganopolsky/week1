...
echo "Compiling PLONK version of Multiplier3.circom..."
...
snarkjs zkey export solidityverifier _plonkMultiplier3/circuit_final.zkey ../Plonk_Multiplier3Verifier.sol
